...
Posted for pipeline commit 832847d
...
* [multiqc_config](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/multiqc_config) - `assets/multiqc_config.yml` does not meet requirements: Section software_versions should have the second lowest order
...
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `save_trimmed_short_reads`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `short_reads_min_len`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_qualified_quality`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_unqualified_percent_limit`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_cut_mean_quality`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_interleaved_in`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_save_merged`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_low_complexity_filter`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_complexity_threshold`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_error_correction`
* [schema_description](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/schema_description) - No description provided in schema for parameter: `fastp_adapter_path`
...
* [nfcore_yml](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/nfcore_yml) - nf-core version in `.nf-core.yml` is not set to the latest version. Should be `3.5.2` but was `3.3.2`
...
* [modules_config](https://nf-co.re/tools/docs/3.5.2/pipeline_lint_tests/modules_config) - `RENDER_HCV_REPORT` found in `conf/modules.config` and Nextflow scripts.
